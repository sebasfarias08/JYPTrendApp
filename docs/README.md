...
- Version en repo: `v1.4.0` (`public/version.json`, fecha `2026-03-19`).
...
- Riesgo vigente de compatibilidad:
  - `public/sw.js` ya precachea rutas modulares reales; tras la segunda limpieza controlada solo queda una superficie legacy minima en `public/js/` y `public/js/components/`.
